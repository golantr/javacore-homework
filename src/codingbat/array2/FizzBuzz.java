...
public class FizzBuzz {
    ...
    will make the String form of an int or other type. This version is a little more complicated
    than the usual version since you have to allocate and index into an array instead of just
    ...
    public static String[] fizzBuzz(int start, int end) {
        ...
        for (int i = 0; i < res.length; i++) {
            ...
            if (currentInt % 15 == 0) {
                ...
                res[i] = String.valueOf(currentInt);
            }
        }
        return res;
    }
